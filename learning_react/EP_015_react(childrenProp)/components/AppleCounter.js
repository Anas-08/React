...
const AppleCounter = () => {
    ...
    return (
        <section>
            ...
            <Button clickHandler={leftClickHandler} imgURL={leftArrow} alternate="Left Arrow"  >
                Left Arrow
            </Button>
            <Button clickHandler={rightClickHandler} imgURL={rightArrow} alternate="Right Arrow"  >
                Right Arrow
            </Button>
